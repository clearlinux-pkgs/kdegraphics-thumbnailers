...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kdegraphics-thumbnailers-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kdegraphics-thumbnailers-25.04.2.tar.xz.sig
...
%setup -q -n kdegraphics-thumbnailers-25.04.2
cd %{_builddir}/kdegraphics-thumbnailers-25.04.2
pushd ..
cp -a kdegraphics-thumbnailers-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749518210
mkdir -p clr-build
pushd clr-build
